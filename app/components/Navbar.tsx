  ...
  return (
    <header className="bg-gradient-to-r from-[#0a0a0a] via-[#0C0C0C] to-[#0a0a0a] backdrop-blur-md border-b border-[#333333] sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 py-4 border-t border-[#333333]">
              ...
              {user ? (
                <div className="flex flex-col gap-3 pt-4 border-t border-[#333333]">
                  ...
                  <Button
                    ...
                    className="border-[#333333] text-gray-300 hover:bg-[#0C0C0C] hover:text-white mx-3 justify-start"
                  >
                    <LogOut className="h-4 w-4 mr-2" />
                    Logout
                  </Button>
                ...
                <div className="pt-4 border-t border-[#333333] px-3">
                  <Link href="/login" onClick={() => setMobileMenuOpen(false)}>
                    <Button
                      variant="outline"
                      size="sm"
                      className="border-[#333333] text-gray-300 hover:bg-[#0C0C0C] hover:text-white w-full justify-start"
                    >
                      Login
                    </Button>
                  </Link>
